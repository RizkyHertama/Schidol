...
//            finish();
    ...
    private void register(String name, String email, String password){
        progressDialog.show(); //Menampilkan loading
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(task.isSuccessful() && task.getResult() != null){
                    ...
                    if(firebaseUser!=null){
                        ...
                        Toast.makeText(getApplicationContext(), "Register unsuccesfully", Toast.LENGTH_SHORT).show();
                    }
    ...
    //akan reload page setelah login
    private void reload(){
